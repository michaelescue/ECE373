...
/** Local include files for kernel functions and typedefs. */
    #include "dmaapi.h"
...
/** Global Structs */
    ...
    static struct tx_desc rx_desc [16] = {0};
...
/** probe: PCI Driver Operations, from Apr 24/29 lecture        */

    static int pci_blinkdriver_probe(struct pci_dev *pdev, const struct pci_device_id *ent){

    /* PCI initialization by probe */
